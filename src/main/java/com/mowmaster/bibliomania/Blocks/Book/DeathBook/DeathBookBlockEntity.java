...
public class DeathBookBlockEntity extends MowLibBaseFilterableBlockEntity {

    public ItemStackHandler itemHandler = createItemHandlerBookStarter();
    ...
    private DeathBookBlockEntity getBookEntity() { return this; }
    ...
    public DeathBookBlockEntity(BlockPos p_155229_, BlockState p_155230_) {
        super(DeferredBlockEntityTypes.BOOK_DEATH.get(), p_155229_, p_155230_);
    }
