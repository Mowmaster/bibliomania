...
public class DeathBookBlockEntityRender implements BlockEntityRenderer<DeathBookBlockEntity> {

    public DeathBookBlockEntityRender(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(DeathBookBlockEntity p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
